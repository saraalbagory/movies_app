...
class ApiLocator {
  ...
  static MovieDetailsDataSource movieDetailsDataSource = MovieDetailsDataSourceImpl();
  static MoviesDetailsRepositry moviesDetailsRepositry =MovieDetailsRepoImpl(movieDetailsDataSource);
}