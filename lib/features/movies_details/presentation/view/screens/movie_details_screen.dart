...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  late Color _iconBookMarkColor;
  @override
  void initState() {
    super.initState();
    _detailsCubit = MovieDetailsCubit();
    _detailsCubit.getMovieDetails(widget.movieId);
    _iconBookMarkColor = Colors.white;
  }

  void changeBookmarkColor() {
    _iconBookMarkColor = _iconBookMarkColor == Colors.white
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ],
      // ),
      body: BlocProvider<WatchlistCubit>(
                      ...
                      style: ButtonStyle(
                        ...
                        padding: WidgetStateProperty.all(
                          EdgeInsets.symmetric(
                              horizontal: 165.w, vertical: 24.h),
                        ), // Padding
